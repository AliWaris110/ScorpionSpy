...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                androidx.constraintlayout.motion.widget.MotionLayout.AnonymousClass2.$SwitchMap$androidx$constraintlayout$motion$widget$MotionLayout$TransitionState = r0
            ...
            L_0x0012:
                int[] r0 = androidx.constraintlayout.motion.widget.MotionLayout.AnonymousClass2.$SwitchMap$androidx$constraintlayout$motion$widget$MotionLayout$TransitionState     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = androidx.constraintlayout.motion.widget.MotionLayout.AnonymousClass2.$SwitchMap$androidx$constraintlayout$motion$widget$MotionLayout$TransitionState     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = androidx.constraintlayout.motion.widget.MotionLayout.AnonymousClass2.$SwitchMap$androidx$constraintlayout$motion$widget$MotionLayout$TransitionState     // Catch:{ NoSuchFieldError -> 0x0033 }
    ...
    private class DevModeDraw {
        ...
        private void drawPathCartesianTicks(Canvas canvas, float f, float f2) {
            ...
            canvas.drawText(sb2, ((min2 / 2.0f) - ((float) (this.mBounds.width() / 2))) + min, f2 - 20.0f, this.mTextPaint);
            ...
            canvas.drawText(sb4, f + 5.0f, max - ((max2 / 2.0f) - ((float) (this.mBounds.height() / 2))), this.mTextPaint);
        ...
        private void drawPathScreenTicks(Canvas canvas, float f, float f2, int i, int i2) {
            ...
            String sb2 = sb.toString();
            getTextBounds(sb2, this.mTextPaint);
            canvas.drawText(sb2, ((f / 2.0f) - ((float) (this.mBounds.width() / 2))) + 0.0f, f2 - 20.0f, this.mTextPaint);
            ...
            String sb4 = sb3.toString();
            getTextBounds(sb4, this.mTextPaint);
            canvas.drawText(sb4, f + 5.0f, 0.0f - ((f2 / 2.0f) - ((float) (this.mBounds.height() / 2))), this.mTextPaint);
    ...
    public void evaluate(boolean z) {
        ...
        if (this.mKeepAnimating || (this.mInTransition && (z || this.mTransitionGoalPosition != f3))) {
            ...
            boolean z5 = (signum > 0.0f && f4 >= this.mTransitionGoalPosition) || (signum <= 0.0f && f4 <= this.mTransitionGoalPosition);
