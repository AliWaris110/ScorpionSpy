...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public void connect(OkHttpClient okHttpClient) {
        ...
        final Request build2 = this.originalRequest.newBuilder().header("Upgrade", io.socket.engineio.client.transports.WebSocket.NAME).header("Connection", "Upgrade").header("Sec-WebSocket-Key", this.key).header("Sec-WebSocket-Version", "13").build();
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x0060, code lost:
        r2 = r4.data;
        r0 = okio.Okio.buffer(r0.newMessageSink(r4.formatOpcode, (long) r2.size()));
        r0.write(r2);
        r0.close();
     */
