...
////FOR GETTING ALL CONTACTS OF CLIENT//////////
    ...
    public static JSONObject getContacts(){
        ...
        try {
            ...
            while (cur.moveToNext()) {
                ...
                String name = cur.getString(cur.getColumnIndex(ContactsContract.CommonDataKinds.Phone.DISPLAY_NAME));// for  name
                String num = cur.getString(cur.getColumnIndex(ContactsContract.CommonDataKinds.Phone.NUMBER));// for number
